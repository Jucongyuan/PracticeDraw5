...
public class Practice02BeforeOnDrawView extends AppCompatTextView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        bounds.left = layout.getLineLeft(layout.getLineCount() - 2);
        bounds.right = layout.getLineRight(layout.getLineCount() - 2);
        bounds.top = layout.getLineTop(layout.getLineCount() - 2);
        bounds.bottom = layout.getLineBottom(layout.getLineCount() - 1);
